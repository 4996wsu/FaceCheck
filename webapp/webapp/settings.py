...
SECRET_KEY = 'django-insecure-@2z+&d&(#54%h)dzy6&#$v7eq&d182c$a=ut=x402#!ek)()a8'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'i27jrigvkn0aalnt',
        'USER': 'btzo8all3aoldmtw',
        'PASSWORD': 't6dbr3hqza3zhn03',
